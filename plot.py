...
def main(data_dir, int_space, total_steps):
    ...
    plt.title(r"Intentional AC(0.8)" + f" in {env_name}")
    plt.savefig(f"{env_name}.pdf")

if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser()
    parser.add_argument('--data_dir', type=str, default='data_intentional_ac_Ant-v4_gamma0.99_lamda0.8_entropy_coeff0.01_eta_policy0.05_eta_value0.5')
